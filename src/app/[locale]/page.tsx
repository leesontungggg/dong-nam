      ...
      <section className="hidden md:flex relative bg-white sm:max-md:container min-h-screen">
        ...
        >
          <div
            className={`${
              locale === "en"
                ? "md:w-[58vw] md:h-[300px] 2xl:w-[44vw] 2xl:h-[42vh]"
                : "md:w-[50vw] md:h-[320px] 2xl:w-[42vw] 2xl:h-[42vh]"
            } flex flex-col md:gap-4 xl:gap-6 h-fit xl:w-[48vw] xl:h-[44vh] justify-center bg-white rounded-[60px] px-8`}
          >
            <h1
